      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-32">
        ...
        <div className="px-4 py-4 space-y-4">
          ...
          <section className="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-stone-100">
            ...
            <ul className="space-y-3">
              {data.observationPoints.map((point, i) => (
                <li key={i} className="flex gap-3 text-base leading-[1.4] text-primary">
            ...
            <section className="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-stone-100">
              ...
              <div className="space-y-3 mb-4">
                {data.wordInsights.map((item, i) => (
                  <div key={i} className="flex gap-3 text-base text-primary">
          ...
          <section className="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-stone-100">
            ...
            <div className="space-y-3 text-base leading-[1.4] text-primary">
          ...
          <section className="bg-white rounded-2xl p-5 shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-stone-100">
            ...
            <ul className="space-y-3 mb-5">
              {data.applicationQuestions.map((q, i) => (
                <li key={i} className="flex gap-3 text-base leading-[1.4] text-primary font-medium italic">
