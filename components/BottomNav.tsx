...
import { BookOpen, PenLine, Menu } from 'lucide-react';
...
export const BottomNav: React.FC<BottomNavProps> = ({ activeTab, onTabChange }) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-stone-100 shadow-[0_-4px_20px_-4px_rgba(0,0,0,0.03)] pb-safe pt-2 px-6 flex justify-between items-center z-40 max-w-md mx-auto">
      <NavItem 
